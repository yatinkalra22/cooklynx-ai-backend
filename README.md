  ...
  functions/
    src/
      ...
      controllers/
        ...
        grocery.tsoa.controller.ts        /v1/grocery/* endpoints
        ingredient.tsoa.controller.ts     /v1/ingredients/* endpoints
        preference.tsoa.controller.ts     /v1/user/preferences endpoints
        subscription.tsoa.controller.ts   /v1/subscription/* endpoints
        webhook.tsoa.controller.ts        /v1/webhooks/* endpoints
      ...
      services/
        ...
        preference.service.ts         User food preferences
        subscription.service.ts       RevenueCat subscription management
      ...
      types/
        ...
        grocery.types.ts          Grocery list types
        preference.types.ts       Preference types
      ...
      middleware/
        ...
        firebase-multer.ts        File upload handling
        multipart.middleware.ts   Multipart form handling
      generated/
